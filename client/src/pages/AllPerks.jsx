...
export default function AllPerks() {
  ...
  // #1 — Load all perks on component mount
  useEffect(() => {
    loadAllPerks()
  }, [])

  // #2 — Auto-search whenever searchQuery or merchantFilter changes (debounced)
  useEffect(() => {
    // Debounce to avoid API spam when typing
  ...
  // #3 — Extract unique merchants whenever perks update
  useEffect(() => {
